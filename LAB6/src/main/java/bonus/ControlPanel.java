...
public class ControlPanel extends JPanel {
    ...
    private void loadGame(ActionEvent e) {
        ...
        try {
            FileInputStream fileIn = new FileInputStream("C:/Users/User/Documents/AP23_2E3_Vornicu_Catalina/LAB6/src/main/java/png/game_bonus.ser");
    ...
    private void saveGame(ActionEvent e) {
        if (frame.canvas.start) {
            try {
                FileOutputStream fileOutputStream = new FileOutputStream("C:/Users/User/Documents/AP23_2E3_Vornicu_Catalina/LAB6/src/main/java/png/game_bonus.ser");
